     ...
     <form action="save-record.jsp" method="post">
      ...
      <div class='row form-group'>
       <div class='col-md-5'>
        ...
        <input type="text" name='firstname' id='fname' class='form-control la' required>
       </div>
       <div class='col-md-5'>
        <label for='lname' class='la'>Enter last name</label><span> *</span>
        <input type="text" name='lastname' id='lname' class='form-control la' required>
       </div>
      </div>
       <div class='row form-group'>
       <div class='col-md-5'>
        <label for='city' class='la'>Enter city</label><span> *</span>
        <input type="text" name='city' id='city' class='la form-control' required>
       </div>
       <div class='col-md-5'>
        <label for='phone' class='la'>Enter phone number</label><span> *</span>
        <input type="text" name='phone' id='phone' class='la form-control' required>
       </div>
      </div>
      <div class='row form-group'>
       <div class='col-md-10'>
